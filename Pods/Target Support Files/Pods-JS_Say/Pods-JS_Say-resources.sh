...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "UMengUShare/UShareSDK/SocialLibraries/Twitter/TwitterKit.framework/TwitterKitResources.bundle"
  install_resource "UMengUShare/UShareSDK/SocialLibraries/Twitter/TwitterKit.framework/TwitterShareExtensionUIResources.bundle"
