...
-(instancetype)initWithBaseURL:(NSURL *)url{
    ...
    if (self = [super initWithBaseURL:url]) {
        ...
        /**设置可接受的类型*/
        [self.responseSerializer setAcceptableContentTypes:[NSSet setWithObjects:@"text/plain",@"application/json",@"text/json",@"text/javascript",@"text/html",@"application/atom+xml", nil]];
    }
