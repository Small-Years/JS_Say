//
//  Technology_WaterFlowViewController.m
//  JS_Say
//
...
@interface Technology_WaterFlowViewController ()<NSXMLParserDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
    NSString *baseUrl;
    int pageIndex;
...
@implementation Technology_WaterFlowViewController
...
//    _collectionView.mj_header = [AllMethod createTableViewHeader:self andSelect:@selector(getData)];
...
-(void)getData{
    ...
    NSString *str = [NSString stringWithFormat:@"http://360web.shoujiduoduo.com/wallpaper/wplist.php?type=getlist&prod=WallPaperDD_ip_1.7.2.4.ipa&listid=19&pg=%d&pc=48&st=hot",pageIndex];
    NSLog(@"科技壁纸：%@",str);
